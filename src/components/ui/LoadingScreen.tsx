            ...
            <div className="text-center max-w-sm mx-auto px-6">
              ...
              {showLogo && (
                <div className="w-24 h-24 mx-auto mb-6 relative">
                  <div className="absolute inset-0 rounded-full border-2 border-blue-400 animate-spin" style={{ animationDuration: '3s' }} />
                  <div className="absolute inset-4 rounded-full bg-gradient-to-br from-blue-500 via-green-500 to-red-500 flex items-center justify-center">
                    <Image
