      ...
      {isVisible && (
        ...
        >
          ...
          <div className="absolute inset-0">
            ...
            <AnimatePresence>
              {showParticles && Array.from({ length: 80 }, (_, i) => (
                <motion.div
                  key={i}
                ...
                >
                  ...
                  <motion.div
                    ...
                    animate={{
                      ...
                      rotate: [0, 180, 360],
                      boxShadow: [
                        `0 0 20px ${['rgba(59, 130, 246, 0.6)', 'rgba(34, 197, 94, 0.6)', 'rgba(239, 68, 68, 0.6)', 'rgba(245, 158, 11, 0.6)', 'rgba(139, 92, 246, 0.6)', 'rgba(6, 182, 212, 0.6)', 'rgba(236, 72, 153, 0.6)'][i]}`,
                        `0 0 40px ${['rgba(59, 130, 246, 0.8)', 'rgba(34, 197, 94, 0.8)', 'rgba(239, 68, 68, 0.8)', 'rgba(245, 158, 11, 0.8)', 'rgba(139, 92, 246, 0.8)', 'rgba(6, 182, 212, 0.8)', 'rgba(236, 72, 153, 0.8)'][i]}`,
                        `0 0 25px ${['rgba(59, 130, 246, 0.7)', 'rgba(34, 197, 94, 0.7)', 'rgba(239, 68, 68, 0.7)', 'rgba(245, 158, 11, 0.7)', 'rgba(139, 92, 246, 0.7)', 'rgba(6, 182, 212, 0.7)', 'rgba(236, 72, 153, 0.7)'][i]}`,
                        `0 0 20px ${['rgba(59, 130, 246, 0.6)', 'rgba(34, 197, 94, 0.6)', 'rgba(239, 68, 68, 0.6)', 'rgba(245, 158, 11, 0.6)', 'rgba(139, 92, 246, 0.6)', 'rgba(6, 182, 212, 0.6)', 'rgba(236, 72, 153, 0.6)'][i]}`
                      ]
                    }}
                    transition={{
